package com.example.waterpipelinesystemproject.config;
...
public class DataSourceConfig {
    ...
    private static final String ENTITY_MANAGER_PACKAGES_TO_SCAN = "com.example.waterpipelinesystemproject.entity";
